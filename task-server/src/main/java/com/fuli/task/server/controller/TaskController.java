package com.fuli.task.server.controller;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.fuli.task.server.model.TaskInfo;
import com.fuli.task.server.model.entity.TaskJobLogs;
import com.fuli.task.server.job.HttpExecuteJob;
import com.fuli.task.server.model.PageParams;
import com.fuli.task.server.model.Result;
import com.fuli.task.server.service.TaskJobLogsService;
import com.fuli.task.server.service.TaskService;
...
public class TaskController {
    ...
    public Result<IPage<TaskJobLogs>> getJobLogList(Map map) {
    ...
    public Result addHttpJob(@RequestParam(name = "jobName") String jobName,
    ...
    public Result updateHttpJob(@RequestParam(name = "jobName") String jobName,
                                    @RequestParam(name = "jobDescription") String jobDescription,
                                    @RequestParam(name = "jobType") String jobType,
                                    @RequestParam(name = "cron", required = false) String cron,
                                    @RequestParam(name = "startTime", required = false) @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") Date startTime,
